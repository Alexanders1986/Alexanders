...
en: {
  nav: { about: "About", skills: "Skills", experience: "Experience", certifications: "Certifications", education: "Education", contact: "Contact" },
  ...
  hero: {
    ...
    profileFacts: [
      ...
      { label: "Engagements", value: "8 delivered" },
  ...
  about: {
    ...
    softSkills: ["Problem-solving", "Leadership & ownership", "Effective communication", "Team collaboration", "Adaptability", "Time management", "Attention to detail"],
  ...
  skills: {
    ...
    jsonPreview: { platform: "Salesforce", role: "Senior Developer", years: 12 },
    technicalTitle: "Technical skills",
    technical: ["Apex", "Lightning Web Components", "Aura Components", "Triggers", "Flows", "Jobs · Batch & Schedule", "Visualforce", "SOQL", "REST API", "JavaScript", "Agentforce", "Git / Bitbucket", "Jenkins", "Jira", "Visual Studio Code"],
    complementaryTitle: "Complementary stack",
    complementary: [".NET", "SQL Server", "PHP", "SOAP", "JSON", "SAP Integrations"],
    tableRows: [
      { label: "Salesforce development", items: "Apex · Triggers · Flows · Jobs (Batch & Schedule) · Visualforce · Lightning Web Components · Aura Components · SOQL · REST API · Agentforce" },
      { label: "Languages & frameworks", items: "JavaScript · .NET · PHP · SQL Server · JSON" },
      { label: "Integration & delivery", items: "SOAP · SAP Integrations · Git / Bitbucket · Jenkins" },
      { label: "Tooling & process", items: "Jira · Visual Studio Code · Agile / SCRUM methodology" }
    ]
  },
  ...
  experience: {
    ...
    items: [
      {
        hash: "7f3a1c2", date: "mar 2026 — present",
        role: "Senior Salesforce Developer",
        context: "Technology consulting firm · Client in the healthcare/insurance sector — Argentina",
        bullets: [
        ...
        tools: "Apex · Agentforce · SOQL · Lightning Flow · Platform Events · Invocable Actions · Git · SFDX · Jira"
      },
      {
        hash: "4d08b91", date: "jul 2025 — dec 2025",
        role: "Senior Salesforce Developer",
        context: "Technology consulting firm · Client in the retail sector — Mexico",
        bullets: [
        ...
        tools: "Salesforce Field Service · Apex · SOQL · LWC · REST API · Triggers · Git/Bitbucket · Jenkins · Jira"
      },
      {
        hash: "9e21fa0", date: "mar 2025 — apr 2025",
        role: "Senior Salesforce Developer",
        context: "Technology consulting firm · Client in the automotive sector — Mexico",
        bullets: [
        ...
        tools: "Salesforce · Apex · SOQL · Flows · Aura Components · Visual Studio Code"
      },
      {
        hash: "c76a552", date: "jan 2025 — feb 2025",
        role: "Senior Salesforce Developer",
      ...
      {
        hash: "02f6cd8", date: "mar 2024 — dec 2024",
        role: "Senior Salesforce Developer",
        context: "Technology consulting firm · Client in the banking sector — Peru",
        bullets: [
      ...
      {
        hash: "b834e17", date: "feb 2023 — mar 2024",
        role: "Senior Salesforce Developer",
        ...
        tools: "Salesforce · Apex · SOQL · Visualforce · SOAP · REST API · Git"
      },
      {
        hash: "5a1908c", date: "nov 2018 — feb 2023",
        role: "Senior Software Development Engineer",
        context: "Education / language-learning sector — multi-country operation (LATAM & APAC)",
        bullets: [
        ...
        tools: "Salesforce · LWC · Apex · Visualforce · JavaScript · Jira · Jenkins · .NET · SQL"
      },
      {
        hash: "0000f01", date: "feb 2013 — jul 2018",
  ...
  certifications: {
    title: "Credentials",
    items: [
      { name: "Salesforce Certified Platform App Builder", date: "Issued February 26, 2026", gold: false, tag: "app builder" },
      { name: "Salesforce Certified Platform Developer I", date: "Issued August 26, 2022", gold: false, tag: "developer I" },
      { name: "Scrum Fundamentals Certified (SFC)", date: "Issued February 23, 2020", gold: true, tag: "fundamentals" }
    ]
  },
  ...
  footer: { rights: "Salesforce Certified Systems Engineer.", backTop: "Back to top ↑" },

  toggle: { lang: "Language", style: "Style", console: "Console", corporate: "Corporate" }
},

es: {
  nav: { about: "Acerca de", skills: "Habilidades", experience: "Experiencia", certifications: "Certificaciones", education: "Educación", contact: "Contacto" },
  ...
  hero: {
    ...
    profileFacts: [
      ...
      { label: "Proyectos", value: "8 entregados" },
  ...
  about: {
    ...
    softSkills: ["Resolución de problemas", "Liderazgo y ownership", "Comunicación efectiva", "Trabajo en equipo", "Adaptabilidad", "Gestión del tiempo", "Atención al detalle"],
  ...
  skills: {
    ...
    complementary: [".NET", "SQL Server", "PHP", "SOAP", "JSON", "SAP Integrations"],
    tableRows: [
      { label: "Desarrollo Salesforce", items: "Apex · Triggers · Flows · Jobs (Batch & Schedule) · Visualforce · Lightning Web Components · Aura Components · SOQL · REST API · Agentforce" },
      { label: "Lenguajes y frameworks", items: "JavaScript · .NET · PHP · SQL Server · JSON" },
      { label: "Integración y despliegue", items: "SOAP · SAP Integrations · Git / Bitbucket · Jenkins" },
      { label: "Herramientas y proceso", items: "Jira · Visual Studio Code · Metodología Agile / SCRUM" }
    ]
  },
  ...
  experience: {
    ...
    items: [
      {
        hash: "7f3a1c2", date: "mar 2026 — actual",
        role: "Senior Salesforce Developer",
        context: "Consultora de tecnología · Cliente del sector salud/seguros — Argentina",
        bullets: [
      ...
      {
        hash: "4d08b91", date: "jul 2025 — dic 2025",
        role: "Senior Salesforce Developer",
        context: "Consultora de tecnología · Cliente del sector retail — México",
        bullets: [
      ...
      {
        hash: "9e21fa0", date: "mar 2025 — abr 2025",
        role: "Senior Salesforce Developer",
        context: "Consultora de tecnología · Cliente del sector automotriz — México",
        bullets: [
      ...
      {
        hash: "c76a552", date: "ene 2025 — feb 2025",
        role: "Senior Salesforce Developer",
      ...
      {
        hash: "02f6cd8", date: "mar 2024 — dic 2024",
        role: "Senior Salesforce Developer",
        context: "Consultora de tecnología · Cliente del sector bancario — Perú",
        bullets: [
      ...
      },
      {
        hash: "5a1908c", date: "nov 2018 — feb 2023",
        role: "Senior Software Development Engineer",
        context: "Sector educación / idiomas — operación multi-país (LATAM y APAC)",
        bullets: [
  ...
  certifications: {
    ...
    items: [
      { name: "Salesforce Certified Platform App Builder", date: "Emitida: 26 febrero 2026", gold: false, tag: "app builder" },
      { name: "Salesforce Certified Platform Developer I", date: "Emitida: 26 agosto 2022", gold: false, tag: "developer I" },
      { name: "Scrum Fundamentals Certified (SFC)", date: "Emitida: 23 febrero 2020", gold: true, tag: "fundamentals" }
    ]
  },
  ...
  footer: { rights: "Salesforce Certified Systems Engineer.", backTop: "↑ volver arriba" },

  toggle: { lang: "Idioma", style: "Estilo", console: "Consola", corporate: "Corporativo" }
}
